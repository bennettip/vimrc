...
if &background == "dark"
    ...
    if s:moria_monochrome == 1
        ...
        hi TabLine cterm=none guibg=#2e2e2e guifg=fg gui=none
        hi TabLineFill guibg=#41609e guifg=#2e2e2e
    ...
    hi TabLineSel cterm=underline guibg=#15539e guifg=fg gui=underline
